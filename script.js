...
(function () {
    ...
    /* Link to projects.html is handled natively now */
    ...
    function initAnimations() {
        ...
        heroTl
            ...
            /* Removed button from timeline to ensure immediate visibility */
        ...
        // About section content entrance (keep existing, maybe add scroll sync?)
        ...
        document.querySelectorAll('.section').forEach(section => {
            const bgText = section.querySelector('.section-tag');
            if (bgText) {
                gsap.to(bgText, {
                    y: -50,
                    opacity: 0.1,
